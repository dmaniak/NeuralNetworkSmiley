========================================================================
    KONSOLENANWENDUNG: NeuralNetworkSmiley-Projektübersicht
========================================================================

Diese NeuralNetworkSmiley-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre NeuralNetworkSmiley-Anwendung besteht.


NeuralNetworkSmiley.vcxproj
...
NeuralNetworkSmiley.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen NeuralNetworkSmiley.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
